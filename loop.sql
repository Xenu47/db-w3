DECLARE
    TYPE CHARS IS VARRAY(10) OF App.app_name%TYPE;
...
BEGIN
    ...
    App_size := CHARS('19M', '14M', '8.7M', '2.8M', '5.6M', '19M', '29M', '33M', '3.1M', '28M');
    ...
    LOOP
        INSERT INTO App (app_name, app_category, app_genre, app_size, last_updated, current_ver) VALUES (App_name(i), App_category(i), App_genre(i), App_size(i), Last_updated(i), Current_ver(i));
        COMMIT;
    END LOOP;
END;